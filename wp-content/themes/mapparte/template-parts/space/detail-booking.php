<div class="col-md-5">
    ...
    <div class="row mx-0 d-sm-none mbl-action-btn">
		<?php if ( ! is_user_logged_in() ) : ?>
			...
			<?php endif; ?>
            <button type="button"
                    class="btn btn-secondary-outline <?php echo ! $contact_only ? 'col-6' : 'col-12'; ?>"><?php echo ! $contact_only ? __("Per info contatta l'host","mapparte") : __("Richiedi un contatto con lo spazio","mapparte");?>
            </button>
		<?php else : ?>
			<?php if ( ! $contact_only ) : ?>
