<div class="col-xl-10 col-md-12">
	...
	<div class="col-md-12">
		<div class="row mx-0 align-items-center">
			<div class="col-md-8">
				<ul class="status-wrapper paid-status-wrapper row align-items-center">
					<li class="col-sm-3">
                        <p><?php echo \Mapparte\Frontend_Utils::format_date_time( $args['date'] ); ?></p>
						<h6><?php echo __("PAGATA","mapparte");?></h6>
					</li>
					<li class="col-sm-6 col-10">
					<?php echo __("La prenotazione è andata a buon fine","mapparte");?>
					</li>
				</ul>
			</div>
		</div>
