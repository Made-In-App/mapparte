    ...
    <div class="row">
        <div class="col-md-8">
            <div class="row">
                ...
                <div class="col-4">
                    <h6 class="booking-detail-ttl">Host</h6>
                </div>
                <div class="col-8">
                    <p class="booking-detail-content"><?php echo esc_html( $host->data->display_name ); ?></p>
                    <div class="review">
						<?php
						if ( $post->post_status === 'feedback' && !get_post_meta( $post->ID, '_rating_guest', true ) ) {
							include( 'rating.php' );
						} else {
							include( 'rating-location.php' );
						}
						?>
                    </div>
                </div>
	    ...
	    <?php if ( 'feedback' === $post->post_status && !get_post_meta( $post->ID, '_rating_guest', true ) ) : ?>
            <div class="col-md-4 feedback-note"><?php echo __("Puoi lasciare un feedback <br>sull’host e il locale","mapparte");?>
            </div>
		<?php endif; ?>
    </div>
</div>
